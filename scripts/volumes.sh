...
docker volume rm audiobook-uploads
...
docker volume create audiobook-uploads --driver local --opt type=nfs --opt o=addr=192.168.1.38,rw --opt device=:"/mnt/TrueNAS/audiobook-uploads"
