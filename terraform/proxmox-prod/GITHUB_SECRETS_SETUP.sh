...
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║   GitHub Secrets Setup for Proxmox Terraform Automation       ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""

echo "This script will help you set up GitHub Secrets needed for:"
echo "  ✓ Nightly drift detection"
echo "  ✓ CI/CD pipeline automation"
echo "  ✓ Safe credential management"
echo ""
...
echo "3. In left sidebar, click 'Secrets and variables' → 'Actions'"
echo ""
...
echo "  Value: $SECRET_2_VALUE  ← Keep this PRIVATE!"
echo "  Click 'Add secret'"
echo ""
...
echo "3. Click 'Run workflow' → 'Run workflow' (green button)"
echo "4. Wait for job to complete (5-10 minutes)"
echo ""
echo "Expected results:"
echo "  ✅ terraform init - SUCCESS"
echo "  ✅ terraform validate - SUCCESS"
echo "  ✅ terraform plan - Shows no changes (or lists expected changes)"
echo ""
...
echo "  ⏰ Time: 2:00 AM UTC (adjust in .github/workflows/proxmox-drift-detection.yml)"
...
echo "  → Check all 3 secrets were added correctly"
echo "  → Verify exact names (case-sensitive)"
echo ""
echo "❌ 'timeout or connection refused'"
echo "  → Proxmox host may be unreachable from GitHub servers"
echo "  → Verify 'https://bd790i.local:8006' is publicly accessible"
echo "  → Or use a public IP instead of .local hostname"
echo ""
echo "❌ 'invalid token'"
echo "  → Verify token hasn't expired"
echo "  → Check token has required Proxmox permissions"
echo "  → Recreate token if needed"
echo ""
